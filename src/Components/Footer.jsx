...
function Footer() {
  return (
    <div className="bg-[#0b2c24] lg:px-28 pt-14 px-10 pb-10">
      <Fade bottom cascade>
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-20">
          <div>
            <h1 className="text-white font-semibold lg:text-2xl">CARBON</h1>
            <p className="text-[#e6e1c5] xl:w-[559px] pt-4">
            ...
            <div className="grid lg:grid-cols-1 xl:grid-cols-2 grid-cols-1 md:grid-cols-1 pt-9">
              <div className="flex gap-2">
                ...
                <div>
                  <p className="text-[#e6e1c5] text-sm">Have a question?</p>
              ...
              <div className="flex gap-2 text-white md:pt-4 pt-4 xl:pt-0">
                ...
                <div>
                  <p className="text-[#e6e1c5] text-sm">Contact us at</p>
          ...
          <div>
            <div>
              ...
              <p className="text-[#e6e1c5] xl:w-[555px] pt-4 pb-5">
                future details
              </p>
        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 pt-16 md:grid-cols-1">
          ...
          <div className="text-[#e6e1c5] lg:justify-end justify-start pt-4 flex md:justify-start md:pt-4 text-xs md:text-base lg:pt-0">
