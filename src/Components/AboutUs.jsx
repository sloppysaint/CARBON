...
function AboutUs() {
  const sectionStyle = "bg-[#000e14] p-8 rounded-lg shadow-lg border border-[#66C5CC]";
  ...
  return (<>
    <div className="min-h-screen flex flex-col bg-gradient-to-r from-[#0f392b] to-[#0f392b]">
      <div className="p-6 md:p-10 lg:p-20 flex-grow flex flex-col items-center relative overflow-hidden">
