...
function CombinedCode() {
  ...
  return (
    <div className="min-h-screen bg-[#1d2e28] text-white p-6">
      ...
      <div className="relative container mx-auto p-6 bg-[#000e14] rounded-lg shadow-lg border border-[#66C5CC] max-w-3xl">
      <div className="p-6 bg-[#18392b] rounded-lg shadow-lg border border-[#66C5CC] mb-8">
  ...
  <div className="space-y-6">
    <div>
      ...
      <input
        ...
        className="w-full p-3 border border-[#66C5CC] rounded bg-[#000e14] text-[#cad9ed] placeholder-gray-400"
    ...
    <div className="text-center">
      <button
        ...
        className="px-6 py-2 bg-[#66C5CC] text-[#000e14] rounded-lg font-semibold hover:bg-[#55B2B6] transition duration-300"
      >
  ...
  {electricityResult && (
    <div className="mt-8 p-6 bg-[#18392b] rounded-lg shadow-lg border border-[#66C5CC]">
      ...
      <ul className="text-lg text-white">
       ...
       <div className="p-6 bg-[#18392b] rounded-lg shadow-lg border border-[#66C5CC] mb-8">
        ...
        {explosionResult && (
          <div className="mt-10 p-6 bg-[#000e14] rounded-lg shadow-lg border border-[#66C5CC]">
