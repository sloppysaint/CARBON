...
function Services() {
  return (
    <div className="bg-[#1d2e28] pt-14 lg:px-28 px-10 pb-20" id="services">
      <Fade bottom cascade>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Service 1 */}
          <div className="p-8 bg-[#344e41] text-white rounded-lg shadow-lg flex flex-col justify-center items-start transition-transform transform hover:scale-105 hover:shadow-2xl">
