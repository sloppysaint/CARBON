...
function NeutralityForm() {
  ...
  const sectionStyle = "bg-[#000e14] p-6 rounded-lg shadow-lg border border-[#66C5CC]";
  ...
  const buttonStyle = "px-6 py-3 text-white font-bold rounded-lg shadow-md transition-transform transform hover:scale-105 bg-[#0b2c24] hover:bg-[#0b2c24] focus:outline-none focus:ring-2 focus:ring-[#55B2B6]";
  ...
  return (
    <div className="p-6 md:p-10 lg:p-20 min-h-screen flex flex-col items-center relative overflow-hidden">
      <div className="absolute inset-0 -z-10">
        <div className="absolute inset-0 bg-gradient-to-r from-[#1d2e28] to-[#0f392b] animate-gradient overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-[#0f392b] to-[#0f392b] opacity-20 animate-pulse"></div>
        </div>
      </div>
      ...
      {/* Display Result */}
      {result && (
        <div className="mt-8 p-6 bg-[#000e14] text-white rounded-lg shadow-lg border border-[#66C5CC] text-center">
